...
$goodword= preg_replace('/u0026/','&',$goodword);
        break;
...
$val=Walk_Ways_each($val,$validation);
  }else{
    $val= validate_word($validation,$val);
  }
...
if(gettype($val)!=gettype($default)){  $val=$default; }
