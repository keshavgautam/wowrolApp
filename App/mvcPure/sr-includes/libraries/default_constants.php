<?php
 ...
 header('Content-Encoding:gzip');
   header('Vary:Accept-Encoding');  
     header("content-security-policy:default-src 'self' 'unsafe-inline' ".cspCDNSTATIC." https://www.google.com;  img-src * 'self' data:; script-src 'unsafe-inline' ".cspCDNSTATIC." https://www.google.com https://www.gstatic.com;  " );
