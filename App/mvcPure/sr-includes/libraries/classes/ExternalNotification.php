...
public function SendActivationCode($args=array()){
    ...
    switch($args['identity_type']){
        ...
        $this->SendSMS_SSDIndia(array('mobileNumber'=>$args['login_identity'],'message'=>' Account Activation code is '.$args['account_activation_key'].' '));
...
public function SendPassword($args=array()){
        ...
        case 'email':
         ...
         $emailargs=array('setFrom'=>array('address'=>setFrom_Email,
                     ...
                     'SentTo'=>array('address'=>$args['login_identity'],
                                       'name'=>$Dispaly_name),
                     'Subject'=>'Wowrol Account Activation',
                     'msgHTML'=>$this->TemplateEmail('Account_Password',array('To_name'=>$Dispaly_name,'password'=>$args['password'], 'Authenticater'=>$args['Authenticater'])),
                     'AltBody'=>'' );
           $ExternalNotification=$this->SendEmail($emailargs);
        break;
        case 'phone':
...
* @return =>
*/
public function SendAccountRecoveryCode($args=array()){
    check_response($args);
    switch($args['identity_type']){
        case 'email':
         $Dispaly_name=$args['login_identity'];
         $emailargs=array('setFrom'=>array('address'=>setFrom_Email,
                     ...
                     'SentTo'=>array('address'=>$args['login_identity'],
                                       'name'=>$Dispaly_name),
                     'Subject'=>'Wowrol Account Recovery',
                     'msgHTML'=>$this->TemplateEmail('AccountRecovery',$args),
                     'AltBody'=>'' );
           $ExternalNotification=$this->SendEmail($emailargs);
        break;
        case 'phone':
     $this->SendSMS_SSDIndia(array('mobileNumber'=>$args['login_identity'],'message'=>' Account Recovery code is '.$args['recovery_code'].' '));
        break;
...
public function Neworder_to_seller($args=array()){
 ...
 /**
* @description=> Notify buyer for order status change.
* @param  =>
* @return =>
*/
public function StatusChange_to_buyer($args=array()){
    switch($args['identity_type']){
        case 'email':
         $Dispaly_name=$args['login_identity'];
         $emailargs=array('setFrom'=>array('address'=>setFrom_Email,
                     ...
                     'msgHTML'=>$this->TemplateEmail('StatusChange_to_buyer',$args),
                     'AltBody'=>'' );
           $ExternalNotification=$this->SendEmail($emailargs);
        break;
        case 'phone':
...
* @return =>
*/
public function FreindShipAccepted($args){
      switch($args['identity_type']){
        case 'email':
         $Dispaly_name=$args['login_identity'];
         $emailargs=array('setFrom'=>array('address'=>setFrom_Email,
                     ...
                     'SentTo'=>array('address'=>$args['login_identity'],
                                       'name'=>$Dispaly_name),
                     'Subject'=>'New Order',
                     'msgHTML'=>$this->TemplateEmail('FreindShipAccepted',$args),
                     'AltBody'=>'' );
           $ExternalNotification=$this->SendEmail($emailargs);
        break;
        case 'phone':
...
$Template.='<div style=" color: #000; line-height: 120%; font-family: inherit; position: relative; padding: 15px 0px;" ><p style="font-size: 14px; line-height: 16px; text-align: center;" ><span style="font-size: 24px; line-height: 28px; font-family: tahoma, arial, helvetica, sans-serif;" ><strong>Account Recovery</strong></span></p></div> <table width="600" border="0" cellspacing="0" cellpadding="0" style="font-family: arial, sans-serif; margin: 0px auto; "><tbody><tr><td align="left" valign="top" style="font-size: 12.8px;"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; border: 1px solid rgb(228, 228, 228); padding: 30px; color: rgb(104, 104, 104); background: rgb(255, 255, 255);"> <p>Hello <br><br>Account recovery operation is helded on account of this '.$data['identity_Name'].'  '.$data['login_identity'].' at  wowrol.com if you do so than please enter the verification code below to set new password.</p><br> <span style="background-color: rgb(255, 255, 255);"><font color="#333333" face="Helvetica Neue, Helvetica, Arial, sans-serif"><span style="font-size: 14px; line-height: 20px;">Verification Code :&nbsp;&nbsp;</span></font></span><code style="box-sizing: border-box; font-family: Menlo, Monaco, Consolas,Courier New, monospace; font-size: 12.6px; padding: 2px 4px; color: rgb(199, 37, 78); border-radius: 4px; background-color: rgb(249, 242, 244);">'.$data['recovery_code'].'</code><span style="color: rgb(51, 51, 51); font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; background-color: rgb(255, 255, 255);">&nbsp;</span> <p><br><br>Thank you.<br><br>Regards,<br>Wowrol</p> <p style="line-height: 20px; margin: 0px; padding: 0px 0px 30px;">&nbsp;</p> </td></tr></tbody></table></td></tr></tbody></table>';
  ...
  case 'Account_activation':
         ...
         case 'Account_Password':
           ...
           $Template.=$this->TemplateEmail('header');
           $Template.='<div style=" color: #000; line-height: 120%; font-family: inherit; position: relative; padding: 15px 0px;" ><p style="font-size: 14px; line-height: 16px; text-align: center;" ><span style="font-size: 24px; line-height: 28px; font-family: tahoma, arial, helvetica, sans-serif;" ><strong>Account Password</strong></span></p></div> <table width="600" border="0" cellspacing="0" cellpadding="0" style="font-family: arial, sans-serif; margin: 0px auto; "><tbody><tr><td align="left" valign="top" style="font-size: 12.8px;"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; border: 1px solid rgb(228, 228, 228); padding: 30px; color: rgb(104, 104, 104); background: rgb(255, 255, 255);"> <p>Hello '.$data['To_name'].',<br><br>We have received your registration details From '.$data['Authenticater'].'. For future direct login to your account, please use the password given below.&nbsp;</p><br> <span style="background-color: rgb(255, 255, 255);"><font color="#333333" face="Helvetica Neue, Helvetica, Arial, sans-serif"><span style="font-size: 14px; line-height: 20px;">Your 6 digit activation key :&nbsp;&nbsp;</span></font></span><code style="box-sizing: border-box; font-family: Menlo, Monaco, Consolas,Courier New, monospace; font-size: 18px; padding: 2px 4px; color: rgb(199, 37, 78); border-radius: 4px; background-color: rgb(249, 242, 244);">'.$data['password'].'</code><span style="color: rgb(51, 51, 51); font-family:Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; background-color: rgb(255, 255, 255);">&nbsp;</span> <p><br><br>Thank you.<br><br>Regards,<br>Wowrol</p> <p style="line-height: 20px; margin: 0px; padding: 0px 0px 30px;">&nbsp;</p> </td></tr></tbody></table></td></tr></tbody></table>';
           $Template.=$this->TemplateEmail('footer');
 ...
 $Template.=$this->TemplateEmail('footer');
         break;
case 'StatusChange_to_buyer':
$Template.=$this->TemplateEmail('header');
  $Template.='<div style=" color: #000; line-height: 120%; font-family: inherit; position: relative; padding: 15px 0px;" ><p style="font-size: 14px; line-height: 16px; text-align: center;" ><span style="font-size: 24px; line-height: 28px; font-family: tahoma, arial, helvetica, sans-serif;" ><strong>Order Status Update </strong></span></p></div> <table width="600" border="0" cellspacing="0" cellpadding="0" style="font-family: arial, sans-serif; margin: 0px auto; "><tbody><tr><td align="left" valign="top" style="font-size: 12.8px;"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td align="left" valign="top" style="font-family:Helvetica Neue, Roboto, Segoe UI, Calibri, sans-serif;font-size: 14px; border: 1px solid rgb(228, 228, 228); padding: 30px; color: rgb(104, 104, 104); background: rgb(255, 255, 255);"> <p style="font-size: 14px; line-height: 18px;">Hi '.$data['buyer_name'].'!</p> <p style="font-size: 14px; line-height: 18px;">Your order <b>'.$data['order_name'].'</b> at  <a href="'.$data['store_url'].'"  style="color: #2c6e99" >'.$data['store_name'].'</a> @'.$data['store_slug'].'  has considered. order status has been changed to <b>'.$data['status_name'].'</b>.</p> <p style="font-size: 14px; line-height: 18px;"> '.$data['More_Information_link'].' </p> <p><br><br>Thank you.<br><br>Regards,<br>Wowrol</p> <p style="line-height: 20px; margin: 0px; padding: 0px 0px 30px;">&nbsp;</p> </td></tr></tbody></table></td></tr></tbody></table>';
$Template.=$this->TemplateEmail('footer');
break;

case 'FreindShipAccepted':
$Template.=$this->TemplateEmail('header');
  $Template.='<div style=" color: #000; line-height: 120%; font-family: inherit; position: relative; padding: 15px 0px;" ><p style="font-size: 14px; line-height: 16px; text-align: center;" ><span style="font-size: 24px; line-height: 28px; font-family: tahoma, arial, helvetica, sans-serif;" ><strong>Friend Requested Accepted </strong></span></p></div> <table width="600" border="0" cellspacing="0" cellpadding="0" style="font-family: arial, sans-serif; margin: 0px auto; "><tbody><tr><td align="left" valign="top" style="font-size: 12.8px;"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td align="left" valign="top" style="font-family:Helvetica Neue, Roboto, Segoe UI, Calibri, sans-serif;font-size: 14px; border: 1px solid rgb(228, 228, 228); padding: 30px; color: rgb(104, 104, 104); background: rgb(255, 255, 255);"> <p style="font-size: 14px; line-height: 18px;">Hi '.$data['frontuser_name'].'!</p> <p style="font-size: 14px; line-height: 18px;">Your friend request accepted by <b>'.$data['actoruser_name'].'</b> at  <a href="'.$data['actoruser_url'].'"  style="color: #2c6e99" >'.$data['actoruser_name'].'</a> @'.$data['actoruser_slug'].'  .  </p><p style="font-size: 14px; line-height: 18px;"> Now enjoy social shopping with <a href="'.$data['actoruser_url'].'"  style="color: #2c6e99" >'.$data['actoruser_name'].'</a> @'.$data['actoruser_slug'].' in your checkin at your local area shops and other shops.  </br> and participate in <a href="'.$data['actoruser_url'].'"  style="color: #2c6e99" >'.$data['actoruser_name'].'\'s</a> @'.$data['actoruser_slug'].'  checkin to suggest your choice of products  to your friend .</p> <p> Wowrol brings a local market shopping behavior on internet. <a href="'.$data['understand_social_shopping_more_link'].'"  style="color: #2c6e99" >  understand  social shopping  more</a>  </p><p style="font-size: 14px; line-height: 18px;"> '.$data['More_Information_link'].' </p> <p><br><br>Thank you.<br><br>Regards,<br>Wowrol</p> <p style="line-height: 20px; margin: 0px; padding: 0px 0px 30px;">&nbsp;</p> </td></tr></tbody></table></td></tr></tbody></table>';
$Template.=$this->TemplateEmail('footer');
break;
...
if (!$mail->send()) {
 ...
 return $return;
  ...
  /**
 *#call $this->SendSMS_SSDIndia(array('mobileNumber'=>789194598,'message'=>''));
 */
 public  function SendSMS_SSDIndia($args=array()){
     //Your authentication key
$authKey = "13983AKEeJ9ueYx35892ca9f";
