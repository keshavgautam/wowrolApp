...
function get_app_class($AppId){
    ...
    if($AppId=="HomePageBuyer"||$AppId==="setting_buyer"||$AppId==="mycheckins"||$AppId=="notifications"||$AppId=="requests"||$AppId=="myorders"||$AppId=="messages"||$AppId=="myshops"||$AppId=="browsinghistory"){
  ...
  if($AppId=="HomePageLocationManager"){
    ...
    if($AppId=="HomePageCompany"||$AppId==="dashboard_companycategories"||$AppId==="dashboard_companymenu"||$AppId==="dashboard_brands"){
...
$script_out.=get_file(ROOT  .$assets.'/Controllers/Utility_ExploreMenu.js') ;
 ...
 $script_out.=get_file(ROOT . $assets.'/vendor/Polyfill/es5-shim.min.js') ;
  $script_out.=get_file(ROOT . $assets.'/vendor/Polyfill/sizzle.min.js') ;
    $script_out.=get_file(ROOT . $assets.'/vendor/Polyfill/Json.js') ;
      $script_out.=get_file(ROOT . $assets.'/vendor/Polyfill/ArrayindexOf.js') ;
     break;
   case 'lang':
...
$script_out.=get_file(ROOT . $assets.'/Controllers/Utility_ZoomWeb.js') ;
$script_out.=get_file(ROOT  .$assetsCore.'/vendor/ZoomWeb/wow_zoom.js') ;
...
$script_out.=get_file(ROOT  .$assetsMob.'/Controllers/Utility_ZoomMobile.js') ;
$script_out.=get_file(ROOT  .$assetsCore.'/Controllers/Utility_spread_comment.js') ; 
$script_out.=get_file(ROOT  .$assetsCore.'/Templates/Tem_spread_comment.js') ; 
$script_out.=get_file(ROOT  .$assetsCore.'/Controllers/Utility_spread_ViewReaction.js') ; 
$script_out.=get_file(ROOT  .$assetsCore.'/Templates/Tem_spread_ViewReaction.js') ; 
...
$script_out.=get_file(ROOT  .$assets.'/Modules/checkins.js') ;
 ...
 case'HomePageBuyer':
   ...
   $script_out=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_HomePageBuyer');
 break;
 case'HomePageStore':
   $script_out=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_HomePageStore');
...
if (file_exists(ROOT  . $assetsCore.'/common/'.$res.'.js')) {
 ...
 $resList=array('loader','vendor','vendorold','bootstrap','main','polyfill','ServiceWorker','lang','market');
  ...
  break; 
  case'HomePageStore':
 $script_out.=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_class_HomePageStore');  
 
  break; 
   case 'HomePageLocationManager':
   $script_out.=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_class_HomePageLocationManager');
  break;

    case 'HomePageCompany':
   $script_out.=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_class_HomePageCompany');
  break;
...
$script_out.=get_file(ROOT  .$assetsCore.'/Components/C10_store-explore-menu_web.js') ;
$script_out.=get_file(ROOT  .$assetsCore.'/Components/C_web_header.js');   
  break;  
...
$script_out.=get_file(ROOT  .$assetsCore.'/Components/C4_hederAlertStore.js') ; 
 ...
 $script_out.=get_file(ROOT  .$assetsCore.'/Components/C10_store-explore-menu.js') ;
       ...
       break;
   case 'advertise':
    $script_out.=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_class_advertise');  
    break;
  ...
  //common to all
 //common to all
  $script_out.=$GLOBALS['Var_Minify']->GET_MINFIED_FILE('web_class_common');
    //inner class switch
