...
this.theme[0]=(this.theme[0]=='')?0:this.theme[0];
 ...
 Handler.prototype.createMarkup=function(){
     ...
     function createStyle(){
         ...
         var ch=''; 
 //  console.log(C);
      ch+='a {color: '+C.dpc+'!important;}a:active{color: '+C.pc+'!important;} svg{fill: '+C.dpc+'!important;}';
           ch+= btn.bind(this)();
         ch+= border.bind(this)();
         ch+= vander.bind(this)();
...
return ch;
 ...
 //    console.log(theme[0]); console.log(ColorSwatches);
 ...
 Handler.classList={
  ...
  vanderbg:[''],  
  dpc:['.dpc'], 
  pc:['.pc','.bg_1','.header-link >.li>a,.header-link-btn,.header-link >.li>a> svg'],
  lpc:['.lpc','.bg_7'],
  ipc:['.ic'],
  ic:['.ic'],
  ac:['.ac','.header-link > .li > a:hover,.header-link > .li > a:focus','.header-link > .li > a.active,.header-link > .li > a:active svg','.header-link > .li > a:hover svg'],
  pt:['.pt','html'],     
  st:['.st'],
  dc:['.dc']       
 };
