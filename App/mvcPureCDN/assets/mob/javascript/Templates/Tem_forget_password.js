...
; (function(W){
   ...
   function ChooseAccount(x){
       ...
       switch(x.type){
      case 'account':
      var tep='<div class="block li _bdy bg_0  "> <div class="block bg_0 fg_5 ff_3 fs14"> <span class="fw-b">'+identity+'</span></div></div>';
