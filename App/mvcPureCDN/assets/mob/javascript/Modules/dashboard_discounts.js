 ...
 */
 ;(function (W) {
  ...
  //== 
   var Madian=function(x){
       var ch='';
   var header= W.T.C.C3_subPageheader({Title: '<a href="'+W.U.URL('dashboard_categories')+'"  class="block header-cell fg_6 al-l"><h2 class=" title" >discount</h2><i class="badge _gbtn"></i> </a>'});
 ...
 W.U.ccbk.Add('pageloaded',function(){
    // Always call inside from function 
      W.U.dashboarddiscounts.init(W.U.id('deshboardwalkway'));
    });
