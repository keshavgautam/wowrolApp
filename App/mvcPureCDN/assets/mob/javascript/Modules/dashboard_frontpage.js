...
//-->>
   ...
   var Madian=function(x){
       var ch='';
   var header= W.T.C.C3_subPageheader({Title: '<a href="'+W.U.URL('dashboard_frontpage')+'"  class="block header-cell fg_6 al-l"><h2 class=" title" >text_86</h2><i class="badge _gbtn"></i> </a>'});
 ...
 W.U.ccbk.Add('pageloaded',function(){
      ...
      W.U.DashboardFrontPage.init(W.U.id('deshboardwalkway'),x);
    });
