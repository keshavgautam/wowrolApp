...
//juntion data supllyed form  core /javascript/common
    ...
    ch+='<div class="block bs-0 bg_0 _bdy m_b10">';
    ch+='<div class="block fw-b"> <div class="block _bdy"><h2>text_121</h2></div><div class="block _bdy t"><span>help_83</span></div></div>';
    ch+='<div class="block-body"> <form name="Signup" data-junction="Signup" onsubmit="return false"> </form> </div>';
    ch+='</div>';
  ...
  var Madian= function(x){
    return  '<div class="block _bdy">'+signup(x)+'<div class="block bs-0  m_b10">'+W.T.Login()+'</div>'+'<div>';
   }
