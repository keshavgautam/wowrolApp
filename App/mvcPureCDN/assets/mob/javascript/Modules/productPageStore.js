...
var page=function(x){
    var ch='<div class="block _bdy  m_b10 bg_0 _B-gray"> <div class="left"> '+W.T.StoreCheckInList.btn(x.SBData,"profilepageStore")+'</div><div class="right"> <button type="button" class="btn btn-primary btn-xs"  data-openbtn="profilepageStore" data-btnid="StoreMenu"  ><span>Explore</span><span></span></button></div></div>';
