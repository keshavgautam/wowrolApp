 ...
 */
 function C3_storehomeheader(x) {
     var URL=W.U.URL;



    var header ={Title: '<a href="'+URL('')+'" class="left"><h2 class="truncate title" >Home</h2><i class="badge _gbtn"></i> </a>'};
...
W.T.C.C3_storehomeheader=C3_storehomeheader;
