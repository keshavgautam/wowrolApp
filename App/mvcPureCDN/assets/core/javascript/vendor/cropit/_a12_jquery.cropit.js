...
(function ($) {
    ...
    Cropit = function () {
        ...
        function Cropit(element, options) {
            ...
            dynamicDefaults = {
                $fileInput: this.$("input." + winjin + "-image-input"),
                $preview: this.$("." + winjin + "-image-preview"),
                $zoomSlider: this.$("input." + winjin + "-image-zoom-input"),
                $previewContainer: this.$("." + winjin + "-image-preview-container")
            };
        ...
        Cropit.prototype.onImageLoaded = function () {
            if (winjin == 'pb') {
              ...
              if (winjin == 'pp') {
              $("." + winjin + "-image-preview").find('a').remove();
