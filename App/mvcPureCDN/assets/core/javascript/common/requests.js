...
//-----------------------
 ...
 if(W.I.wf=="mob"){
 var header= W.T.C.C3_subPageheader({Title: '<a href="'+W.U.URL('requests')+'"  class="block header-cell fg_6 al-l"><h2 class=" title" >text_198</h2><i class="badge _gbtn"></i> </a>'});
...
var setting ={
 ...
 W.U.FreindRequest.init(W.U.id('walkway'));
    });
