...
//-----------------------
 ...
 if(W.I.wf=="mob"){
 var header= W.T.C.C3_subPageheader({Title: '<a href="'+W.U.URL('myshops')+'"  class="block header-cell fg_6 al-l"><h2 class=" title" >myshops</h2><i class="badge _gbtn"></i> </a>'});
...
var setting ={
 ...
 W.U.myshops.init(W.U.id('walkway'));
    });
