...
var frombody=W.T.company_settings.BasicInfoPage;

var formLogic =function() {
  var  f_value = W.F.walk_way_all(['company_name','company_industry_category'], this.formname),
       error=2, alert_mes = [];
...
var Ragisterdata={
  ...
  var ch ='<form name="company_setting_0"  data-junction="company_setting_0" onsubmit="return false"> </form>';
   
 W.U.Junction('company_setting_0',function(){
...
//---------------------
  ...
  SettingLink.push({href:'javascript:void(0);',text:'text_192',icon:'',attrStr:' data-pagerbtn="'+ W.I.dp+':BasicInfoPage:setting:0" ',help:'help_3'});
