...
;wowrol = {
    ...
    F: {}, //froms
    I: {}, //varibles
    G: {}, //common modul extent
    KKJ: {}, //kkcomponent junction
    J: {}//Junction
};
/*
* Basic Utility
...
var doca=document; 
var frag = doca.createDocumentFragment(),
      elem = doca.createElement('div'),
      range = doca.createRange && doca.createRange();

       frag.appendChild(elem);
  range && range.selectNodeContents(elem);

function fun1(html) {
      if (!html) return doca.createDocumentFragment();
...
$(element).on(name,data);
 ...
 W.U.createElement = function (nodeName) {
      return document.createElement(nodeName);
    };
 
  W.U.createText = function (text) {
...
function console(x){
    if(W.C.Setting.SERVER_MODE=="DEVELOPMENT"){
