...
; (function(W){
  ...
  var Feature = {
    ...
    pushState:(typeof history.pushState=='function')?true:false,
  ...
  Feature.supportCSS3=(Feature.css3Dtransform&&Feature.cssTransform&&Feature.cssTransition)?true:false;
