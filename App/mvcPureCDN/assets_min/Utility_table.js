...
function Table() { 
 ...
 function Handler(wrap,Value) { 
        this.wrap = wrap;
       this.Value = W.U.extend(Handler.Default, Value);
    this.crosscheck = 0;
...
var mainBlock=W.U.Rander(tableMarkup);
   ...
   this.Value.onbeforeinsert.bind({mainBlock:mainBlock})();


 W.U.Setview(this.wrap,mainBlock,'html');  
       ...
       break;
        ...
        function calculateCellwidth() {
           ...
           parentWidth=(parentWidth-20);
            ...
            //   W.U.console('parentWidth ==' + parentWidth);
            var rowcheck = this.Value.setting.rowcheck;
            var restcol = (this.col - 1);
            if (rowcheck) {
                parentWidth = (parentWidth - 30);
                //      W.U.console('rowcheck ==' + 30);
            }
            ...
            //     W.U.console('firstcolwidth ==' + firstcolwidth);
            var TotalRestcolwidth = ((parentWidth - firstcolwidth)) - restcol;
            var Restcolwidth = Math.floor((TotalRestcolwidth / restcol));

            //        W.U.console('TotalRestcolwidth ==' + TotalRestcolwidth);
            //      W.U.console('restcol ==' + restcol);
            //      W.U.console('Restcolwidth ==' + Restcolwidth);
