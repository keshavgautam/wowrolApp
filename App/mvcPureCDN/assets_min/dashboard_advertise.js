...
//-----------------------
 ...
 if(W.I.wf=="mob"){
 var header= W.T.C.C3_subPageheader({Title: '<a href="'+W.U.URL('market')+'"  class="block header-cell fg_6 al-l"><h2 class=" title" >text_327</h2><i class="badge _gbtn"></i> </a>'});
...
var setting ={
 ...
 W.U.ccbk.Add('pageloaded',function(){
        ...
        W.U.dashboard_advertise.init(W.U.id('walkway'));
    });
