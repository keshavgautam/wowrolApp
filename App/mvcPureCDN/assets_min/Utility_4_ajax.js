...
/**
*@call W.U.base64_decode(str)
*/
function base64_decode(str){
    return Encription.base64decode(str);
}

/**
*@call W.U.arraybase64_decode(str)
*/
function  arraybase64_decode(arr){
    var ret=Array();
    if(W.U.isArray(arr)||W.U.isObject(arr)){
   for(var q in arr){
    if(W.U.isArray(arr[q])){
        ret[q]=arraybase64_decode(arr[q]);  
     }else if( W.U.isObject(arr[q])){
     ret[q]=arraybase64_decode(arr[q]);  
   
     }else if(W.U.isString(arr[q])){
           
         ret[q]=base64_decode(arr[q]);  
          
     }else if(W.U.isPlainObject(arr[q])){
 ...
 W.U.ajax= ajax;
 W.U.base64_decode=base64_decode; 
 W.U.arraybase64_decode=arraybase64_decode; 
})(wowrol);