<?php
 ...
 header('Content-Encoding:gzip');
   ...
   /*  header("content-security-policy:default-src 'self' 'unsafe-inline' ".cspCDNSTATIC." https://*.google.com https://api.cloudinary.com;  img-src * 'self' data:; script-src 'unsafe-inline' ".cspCDNSTATIC." https://*.google.com https://www.gstatic.com ;  " );*/
