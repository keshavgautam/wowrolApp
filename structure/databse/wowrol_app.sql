...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2017 at 12:12 PM
...
CREATE TABLE IF NOT EXISTS `accounts_0` (
  `account_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `login_0`
--

CREATE TABLE IF NOT EXISTS `login_0` (
  `login_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `account_id` bigint(20) NOT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=2276 ;
