...
//  header(' Content-Type:text/html;charset=utf-8');
 ...
 header('Content-Encoding:gzip');
   header('Vary:Accept-Encoding');  
     header("content-security-policy:default-src 'self' 'unsafe-inline' ".cspCDNSTATIC." ".URLParseURL."   ".CDNUPLOAD."  ".docHELPURL."  ".implode('  ', $GLOBALS['Var_UpdaterServerURL'] ) ." https://*.google.com https://api.cloudinary.com;  img-src * 'self' data:; script-src 'unsafe-inline' ".cspCDNSTATIC." ".CDNUPLOAD." https://*.google.com https://www.gstatic.com  https://www.google-analytics.com ; style-src  'unsafe-inline' https://fonts.googleapis.com  ".cspCDNSTATIC." ; font-src  https://fonts.gstatic.com   ;" );
